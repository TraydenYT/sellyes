...
<body>
    ...
    <section class="mobile" id="mobile">
        ...
        <div class="row">
            ...
            <div class="mobile__inner">
                <a href="https://www.hltv.org/" target="_blank">
                    <div class="mobile_item mobile_item_15">
                        <div class="mobile__item_subtitle">
                            <div class="mobile__item_plus">
                            </div>
                        </div>
                ...
                <a href="https://www.hltv.org/" target="_blank">
                    <div class="mobile_item mobile_item_16">
                        <div class="mobile__item_subtitle">
                            <div class="mobile__item_plus">
                            </div>
                        </div>
                ...
                <a href="https://www.hltv.org/" target="_blank">
                    <div class="mobile_item mobile_item_17">
                        <div class="mobile__item_subtitle">
                            <div class="mobile__item_plus">
                            </div>
                        </div>
                ...
                <a href="https://www.hltv.org/" target="_blank">
                    <div class="mobile_item mobile_item_18">
                        <div class="mobile__item_subtitle">
                            <div class="mobile__item_plus">
                            </div>
                        </div>
                ...
                <a href="https://www.hltv.org/" target="_blank">
                    <div class="mobile_item mobile_item_19">
                        <div class="mobile__item_subtitle">
                            <div class="mobile__item_plus">
                            </div>
                        </div>
                ...
                <a href="https://www.hltv.org/" target="_blank">
                    <div class="mobile_item mobile_item_20">
                        <div class="mobile__item_subtitle">
                            <div class="mobile__item_plus">
                            </div>
                        </div>
                ...
                <a href="https://www.hltv.org/" target="_blank">
                    <div class="mobile_item mobile_item_21">
                        <div class="mobile__item_subtitle">
                            <div class="mobile__item_plus">
                            </div>
                        </div>
            ...
            <div class="mobile__inner">
                <a href="https://www.hltv.org/" target="_blank">
                    <div class="mobile_item mobile_item_22">
                        <div class="mobile__item_subtitle">
                            <div class="mobile__item_plus">
                            </div>
                        </div>
                ...
                <a href="https://www.hltv.org/" target="_blank">
                    <div class="mobile_item mobile_item_23">
                        <div class="mobile__item_subtitle">
                            <div class="mobile__item_plus">
                            </div>
                        </div>
                ...
                <a href="https://www.hltv.org/" target="_blank">
                    <div class="mobile_item mobile_item_24">
                        <div class="mobile__item_subtitle">
                            <div class="mobile__item_plus">
                            </div>
                        </div>
                ...
                <a href="https://www.hltv.org/" target="_blank">
                    <div class="mobile_item mobile_item_25">
                        <div class="mobile__item_subtitle">
                            <div class="mobile__item_plus">
                            </div>
                        </div>
                ...
                <a href="https://www.hltv.org/" target="_blank">
                    <div class="mobile_item mobile_item_26">
                        <div class="mobile__item_subtitle">
                            <div class="mobile__item_plus">
                            </div>
                        </div>
                ...
                <a href="https://www.hltv.org/" target="_blank">
                    <div class="mobile_item mobile_item_27">
                        <div class="mobile__item_subtitle">
                            <div class="mobile__item_plus">
                            </div>
                        </div>
                ...
                <a href="https://www.hltv.org/" target="_blank">
                    <div class="mobile_item mobile_item_28">
                        <div class="mobile__item_subtitle">
                            <div class="mobile__item_plus">
                            </div>
                        </div>
   ...
   <!-- <section class="inner">
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-2">
                    <div class="inner__trustpilot">
                        <a href="#"><img src="img/Trustpilo.png" alt="#" class="inner__trustpilot-image"></a>
                        <div class="inner__stars">
                            <ul class="inner__trustpilot-ul">
                                    <li>
                                        <img src="img/Trustpilo2.png" class="inner__trustpilot-stars" alt="">
                                    </li>
                                    <li>
                                        <img src="img/Trustpilo2.png" class="inner__trustpilot-stars" alt="">
                                    </li>
                            ...
                            <div class="inner__text">SellYes получил оценку 4.9 из 5 при более чем 11 827 отзывах.</div>
                        </div>
                    </div>
                </div>
                <div class="col-md-10">
   ...
   <!-- <section class="block5">
    <div class="container-fluid">
        <div class="block5__wrapper">
             <div class="block5__left">
                <img src="" alt="#">
            </div> 
            <div class="block5__right">
                <div class="block5__text">Преимущества работы с SELLYES</div>
                <div class="block5__subtitile">Мы стараемся сделать быстрый, а самое главное качественную работу между пользователями.</div>
                <div class="block5__label">Получилось у нас или нет — проверьте сами.</div>
                <a href="#"><button class="button button_edge">Попробывать прямо сейчас</button></a>
