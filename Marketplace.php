...
<body>
<section class="promo promo__market">
        <div class="container-fluid">
            ...
            <section class="list">
                    <list class="wrapper d-flex">
                        <div class="list__slick">
                            <a href="#">Аккаунты</a>
                        </div>
                        <div class="list__slick">
                            <a href="#">Скины</a>
            ...
            <section class="seller">
                <div class="seller__wrapper d-flex">
                    <div class="seller__left">
                        <div class="seller__left-wrapper">
                        </div>
                    </div>
                    <div class="seller__right">2</div>
                </div>
            </section>
